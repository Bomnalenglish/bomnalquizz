...
t('여기서 뺀 번호는 저쪽이 다른 걸 건드려도 되살아나지 않는다', SM(merge(S(['가','나'],{가:{A:[1]},나:{A:[5]}}), S(['가','나'],{가:{A:[1,2]},나:{A:[5]}}), S(['가','나'],{가:{A:[1,2]},나:{A:[5,6]}}))), SM(S(['가','나'],{가:{A:[1]},나:{A:[5,6]}})));
t('저쪽에서 뺀 번호도 여기서 다른 걸 건드리면 빠진다', SM(merge(S(['가','나'],{가:{A:[1,2]},나:{A:[5,6]}}), S(['가','나'],{가:{A:[1,2]},나:{A:[5]}}), S(['가','나'],{가:{A:[1]},나:{A:[5]}}))), SM(S(['가','나'],{가:{A:[1]},나:{A:[5,6]}})));
t('양쪽이 새로 넣은 번호는 둘 다 살린다', SM(merge(S(['가','나'],{가:{A:[1,2]},나:{A:[5]}}), base, S(['가','나'],{가:{A:[1,3]},나:{A:[5,6]}}))), SM(S(['가','나'],{가:{A:[1,2,3]},나:{A:[5,6]}})));
